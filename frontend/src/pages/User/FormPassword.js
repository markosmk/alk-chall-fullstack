  ...
  return (
    <form>
      <div className="bg-white py-6 px-4 space-y-6 sm:p-6 lg:pb-8 rounded-md sm:overflow-hidden">
        <div>
          <h3 className="text-xl leading-6 font-medium text-black">Cambiar Contraseña</h3>
      ...
      <div className="px-4 py-3 text-right sm:px-6">
        <button
          type="submit"
          className="bg-black border border-transparent rounded-md shadow-sm py-2 px-4 inline-flex justify-center text-sm font-medium text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black"
        >
          Guardar Cambios
        </button>
      </div>
